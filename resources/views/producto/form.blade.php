...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control" name="nombre_producto" placeholder="Ingrese nombre del Producto"
                    value="{{ isset($producto->nombre_producto) ? $producto->nombre_producto : old('nombre_producto')  }}"
                    id="nombre_producto" autofocus>
                @if ($errors->has('nombre_producto'))
                <span class="error text-danger"
                    for="input-nombre_producto">{{ $errors->first('nombre_producto') }}</span>
                @endif
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control" name="descripcion" placeholder="Ingrese su Descripcion"
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control" name="marca" placeholder="Ingrese su Marca"
                    value="{{ isset($producto->marca) ? $producto->marca : old('marca')  }}" id="marca">
                @if ($errors->has('marca'))
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                <input type="number" class="form-control" name="cantidad" placeholder="Ingrese su Cantidad"
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                <input type="number" class="form-control" name="codigo_barra" placeholder="Ingrese Codigo de Barra"
                    value="{{ isset($producto->codigo_barra) ? $producto->codigo_barra : old('codigo_barra')   }}"
                    id="codigo_barra">
...
@if ($errors->has('stock'))
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                <input type="number" class="form-control" name="precio_compra" placeholder="Ingrese Precio de Compra"
                    value="{{ isset($producto->precio_compra) ? $producto->precio_compra : old('precio_compra') }}"
                    id="precio_compra">
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                <input type="number" class="form-control" name="precio_venta" placeholder="Ingrese precio de Venta"
                    value="{{ isset($producto->precio_venta) ? $producto->precio_venta : old('precio_venta')  }}"
                    id="precio_venta">
