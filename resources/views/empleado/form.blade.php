...
<input type="text" class="form-control" name="tipo_identificacion" value="{{ isset($empleado->tipo_identificacion) ? $empleado->tipo_identificacion:old('tipo_identificacion')  }}" id="tipo_identificacion">
</div>
<div class="form-group">
<label for="Numero de Identificacion"> Numero de identificacion </label>
<input type="text" class="form-control"  name="numero_identificacion" value="{{ isset($empleado->numero_identificacion) ? $empleado->numero_identificacion:old('numero_identificacion')  }}" id="numero_identificacion">
</div>
<div class="form-group">
